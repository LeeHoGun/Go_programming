...
func main() {
	...
	// var a int // declaration = 선언
	// a = 7     // assign value = 가치 할당
	...
	fmt.Println('Z', '2', '\n', '김', '인', '하') // rune literals(int32) 90, 50, 10, 44608 ,51604, 54616 	unicode.org
	fmt.Println(reflect.TypeOf('Z'), reflect.TypeOf(2), reflect.TypeOf("Hi"), reflect.TypeOf(4.99), reflect.TypeOf(false))
	// fmt.Println(math.Floor("삼, 오"), math.Ceil("이백심칠쩜칠"), math.Sqrt("sixteen"))
